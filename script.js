...
class UI{
  ...
  addCartItem(item){
    ...
    <div>
        <img src="icons/arrow-drop-up.svg" alt="" class="fa-chevron-up" data-id=${item.id}>
        <p class="item-amount">${item.amount}</p>
        <img src="icons/arrow-drop-down-sharp.svg" alt="" class="fa-chevron-down" data-id=${item.id}>
    </div>`;
  ...
  removeItem(id){
    ...
    button.innerHTML=`<img src="icons/shopping-cart.svg" alt="">
    ADD TO CART`;
  }
  getSingleButtton(id){
